...
namespace asp_net_po_schedule_management_server.Migrations
{
    ...
    [Migration("20220606082921_AddIdentifierProperty")]
    partial class AddIdentifierProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("asp_net_po_schedule_management_server.Entities.ContactFormIssueType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("contact-form-issue-types");
                });

            modelBuilder.Entity("asp_net_po_schedule_management_server.Entities.ContactMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("Email")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)")
                        .HasColumnName("anonymous-email");

                    b.Property<bool>("IfAnonymous")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("if-anonymous");

                    b.Property<string>("MessageIdentifier")
                        .HasMaxLength(8)
                        .HasColumnType("varchar(8)")
                        .HasColumnName("mess-identifier");

                    b.Property<string>("Name")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)")
                        .HasColumnName("anonymous-name");

                    b.Property<long?>("PersonId")
                        .HasColumnType("bigint")
                        .HasColumnName("user-key");

                    b.Property<string>("Surname")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)")
                        .HasColumnName("anonymous-surname");
            ...
            modelBuilder.Entity("contact-messages-groups-binding", b =>
                {
                    b.Property<long>("contact-message-key")
                        .HasColumnType("bigint");

                    b.Property<long>("group-key")
                        .HasColumnType("bigint");

                    b.HasKey("contact-message-key", "group-key");

                    b.HasIndex("group-key");

                    b.ToTable("contact-messages-groups-binding");
                });
            ...
            modelBuilder.Entity("asp_net_po_schedule_management_server.Entities.ContactMessage", b =>
                {
                    b.HasOne("asp_net_po_schedule_management_server.Entities.ContactFormIssueType", "ContactFormIssueType")
                        .WithMany()
            ...
            modelBuilder.Entity("contact-messages-groups-binding", b =>
                {
                    b.HasOne("asp_net_po_schedule_management_server.Entities.ContactMessage", null)
                        .WithMany()
                        .HasForeignKey("contact-message-key")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
